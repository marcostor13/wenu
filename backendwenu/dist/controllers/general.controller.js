...
function create(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            yield admin.firestore().collection(collection).add(JSON.parse(data));
...
function get(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const snapshot = yield admin.firestore().collection(collection).doc(id).get();
        const results = {
            id: snapshot.id,
            data: snapshot.data()
        };
...
function patch(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const { collection, id } = req.params;
            const { data } = req.body;
            return yield admin.firestore().collection(collection).doc(id).update(JSON.parse(data)).then(_ => {
